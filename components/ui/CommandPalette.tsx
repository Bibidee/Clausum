...
type PaletteCommand = { id: string; label: string; hint: string; Icon: typeof Home; href?: string; run?: () => void; disabled?: boolean };
...
export function CommandPalette() {
  ...
  const { agreementId, canonicalHash, tx, reset, status } = useFormation();
