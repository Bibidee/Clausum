...
export function FormationProvider({ children }: { children: ReactNode }) {
  ...
  return <FormationContext.Provider value={{ ...state, partyA, partyB, partyAObligations, partyBObligations, conflicts, ready, formed, life, model, reset, configureDraft, amend, connect, evaluate, ratify }}>{children}</FormationContext.Provider>;
}
